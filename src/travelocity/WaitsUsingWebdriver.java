...
public class WaitsUsingWebdriver extends MethodsReuse {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input#flight-origin-flp")).sendKeys("Alexandria, LA (AEX-Alexandria In");
		
		driver.findElement(By.cssSelector("input#flight-destination-flp")).sendKeys("Dublin, Ireland (DUB)");
		...
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@class='bold announce-able]")));
